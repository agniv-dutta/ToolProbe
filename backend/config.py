...
class Settings(BaseSettings):
    ...
    RESEARCH_MODEL: str = Field(default="llama-3.1-8b-instant", description="Groq model for research agent")
    VERIFICATION_MODEL: str = Field(default="llama-3.1-8b-instant", description="Groq model for verification")
    LLM_MODEL: str = Field(default="llama-3.1-8b-instant", description="Groq model for LLM features")
